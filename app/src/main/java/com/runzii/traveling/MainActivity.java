...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        result = new Drawer()
                ...
                .addDrawerItems(
                        new PrimaryDrawerItem().withName("maps").withIcon(GoogleMaterial.Icon.gmd_style).withIdentifier(1).withCheckable(false),
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem != null) {
                            ...
                            if (drawerItem.getIdentifier() == 1) {
                                intent = new Intent(MainActivity.this, FullscreenDrawerActivity.class);
                            }
                            if (intent != null) {
